...
class Template {
    ...
    */
    ...
    private function DiscloseFunctions( $tpl ) {
        ...
        $tpl = preg_replace( '!\{print:\s*(.*)\}!i', '<?php echo (\\1)?>', $tpl );
        ...
        $tpl = preg_replace( '!\{(strip|htmlquoted|htmlescape):\s*([^\}]+)\}!i', '<?php echo isset(\\2)?strip_tags(\\2,"<div><p><a><span><b><strong><u><i><em><ul><ol><li>"):""?>', $tpl );
