...
class sitemap
{
    ...
    private $latest_lastmod = array(); //ластмод для итогового сайтмепа
    ...
    * @return  mixed
    */
    public function multi_curl_site_urls( $urls, $prefix=null, $login=null, $password=null, $limit=null ){
         global $log;
        //счетчики 404 и 0
        $i_404=0;$i_0=0;
        ...
        $result['server_answers']=array();
        //title прочитанных страниц
        $result['pages_titles']=array();
        //время прочтения страниц
        $result['pages_date']=array();
        //в архиве объект, или нет
        $result['in_archive']=array();
        $i=0;
        //счетчик url
        $urls_processed=0;
        //setting curl handlers
    ...
    * @return  mixed
    */
    public function curl_site_urls($urls,$prefix=null,$login,$password,$limit=null){
        global $log;
        //счетчики 404 и 0
        $i_404=0;$i_0=0;
        //для curl handlers
    ...
    * @return bool
    */   
    public function finish_maps_manually(){
        global $log, $root;
