...
return array(
    'metallokonstrukcii' => array(
        ...
        ,'title' => array(
            ...
            'fieldtype' => 'text',
            'label' => 'Название',
            'placeholder' => 'Название металлоконструкции'
        )
        ...
        ,'published' => array(
            ...
            'label' => 'Показывать металлоконструкцию'
        )
        ...
        ,'photogallery' => array(
            'url' => '/manage/metallokonstrukcii/photos/', 
            'limit' => 20,
            'parent_class' => 'full-width', 
            'fieldtype' => 'photos',
            'switcher' => 'true',
            'label' => 'Фотографии металлоконструкции'
        )
