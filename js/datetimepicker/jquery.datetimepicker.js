	...
	$.fn.datetimepicker = function( opt ){
		...
		var createDateTimePicker = function( input ){
			var datetimepicker = $('<div class="xdsoft_datetimepicker"></div>'),
				...
				mounth_picker = $('<div class="xdsoft_mounthpicker"><div class="xdsoft_prev">&lsaquo;</div><div class="xdsoft_label xdsoft_month"></div><div class="xdsoft_label xdsoft_year"></div><div class="xdsoft_next">&rsaquo;</div></div>'),
				calendar = $('<div class="xdsoft_calendar"></div>'),
				timepicker = $('<div class="xdsoft_timepicker active"><div class="xdsoft_prev">&lsaquo;</div><div class="xdsoft_time_box"></div><div class="xdsoft_next">&rsaquo;</div></div>'),
