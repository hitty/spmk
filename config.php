...
return array(
    ...
    ,'forms' => [   // данные форм запроса
        ...
        ,
        'kmd_gift' => [  //кмд в подарок - форма лояльным пользователям
            'form_title' => 'Новым заказчикам металлоконструкций КМД в подарок',
            'form_text' => 'При заказе изготовления конструкций от 100 тонн - проект КМД в подарок!<br/><br/>Введите свой номер телефона и нажмите «Хочу подарок».',
            'success_title' => 'Спасибо!<br/> Запрос отправлен.',
            'success_text' => 'Пожалуйста, не дублируйте свой запрос, наши специалисты с вами обязательно свяжутся.',
            'template' => 'templates/includes/form.kmd.gift.html',
